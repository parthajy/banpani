...
const PRECACHE = [
  ...
  'manifest.webmanifest', 'data/assam-districts.geojson', 'data/relief-camps.json', 'data/odisha-districts.geojson', 'data/odisha-camps.json', 'data/colombia-districts.geojson', 'data/colombia-camps.json',
