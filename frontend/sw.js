...
const CACHE = 'banpani-v95';
const PRECACHE = [
  './', 'index.html', 'styles.css', 'app.js', 'config.js', 'fullscreen.js', 'i18n.js',
  'vendor/leaflet/leaflet.js', 'vendor/leaflet/leaflet.css',
  'about.html', 'privacy.html', 'press.html', 'how-it-works.html', 'manifesto.html', 'contributors.html', 'volunteers.html', 'archive.html', 'doc.css', 'doc.js',
  'banpani_favicon.png', 'banpani_logo.png', 'icon-192.png', 'apple-touch-icon.png',
  'manifest.webmanifest', 'data/assam-districts.geojson', 'data/relief-camps.json', 'data/odisha-districts.geojson', 'data/odisha-camps.json', 'data/colombia-districts.geojson', 'data/colombia-camps.json', 'data/bangladesh-districts.geojson', 'data/bangladesh-camps.json',
