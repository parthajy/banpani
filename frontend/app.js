...
(function initLang() {
  const LABEL = { en: 'EN', as: 'অস', bn: 'বাং', hi: 'हि', or: 'ଓଡ଼ି', es: 'ES', ta: 'தமிழ்', mr: 'मराठी', te: 'తెలుగు', kn: 'ಕನ್ನಡ', ml: 'മലയാളം', gu: 'ગુજરાતી', pa: 'ਪੰਜਾਬੀ', mai: 'मैथिली', kok: 'कोंकणी', ne: 'नेपाली' };
